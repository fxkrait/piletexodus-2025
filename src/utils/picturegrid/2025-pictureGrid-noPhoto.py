...
import glob
#from cv2 import *
from cv2 import (VideoCapture, namedWindow, imshow, waitKey, destroyWindow, imwrite, imread, hconcat, vconcat, resize, INTER_LINEAR)
import time

images = [imread(file) for file in glob.glob("photos64/*.jpg")]
...
# imwrite("image.png", image_v) # crashes my phone
